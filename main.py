...
img_obj2 = PhotoImage(file="img/2.png")
...
sc.create_text(390, 65,text="TETRIS", font=("DEATHNOTE Font", 30),fill="red", anchor=NW)
sc.create_text(370, 130,text="Score:", font=("DEATHNOTE Font", 20),fill="red", anchor=NW)
_score = sc.create_text(370, 165,text=str(score), font=("DEATHNOTE Font", 20),fill="gold", anchor=NW)
sc.create_text(370, 195,text="Record:", font=("DEATHNOTE Font", 20),fill="red", anchor=NW)
_record = sc.create_text(370, 225,text=record, font=("DEATHNOTE Font", 20),fill="red", anchor=NW)
...
while app_running:
    if app_running:
        ...
        # draw next figure
        for i in range(4):
            figure_rect_x = next_figure[i][0] * TILE + 283
            figure_rect_y = next_figure[i][1] * TILE + 350
